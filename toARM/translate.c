...
void translate(armcode *newnode, struct codenode *p, armop armop, armcode *q)
{
    ...
    else if (rn0 == -2)
    {
        ...
        if(R_res == R11)
            ...
            Addres = R11;
        //后插
        ldrnode = create_ldrnode(Addres, p->result.id, 0, 0);
        q->next = ldrnode;
        ldrnode->pre = q;
        q = ldrnode;

        strnode = create_strnode(R_res,Addres,0);
        q->next = strnode;
        strnode->pre = q;
        q = strnode;
    }
...
armcode *translatearm(Blocks *blocks)
{
        ...
        for (int i = 0; i < cur_blocks->count; i++)
        {
            ...
            while (p != NULL)
            {
                ...
                case FUNCTION:
                    ...
                    cur_stk_offset = func_enter_subindex - 4; //从高往低压，压局部溢出变量和数组时，手动改变改指针
                    ...
                    else
                    {
                        ...
                        subnode->oper2.type = REG;
                        subnode->oper2.value = R_res;
                    }
                    q->next = subnode;
                    subnode->pre = q;
                    q = subnode;
                ...
                case END:
                    ...
                    segnode = initnewnode();
                    segnode->op = SEG_LABEL;
                    segnode->result.type = STRING;
                    strcpy(segnode->result.str_id,".ltorg");
                    armlink_insert(newnode,segnode);

                    segnode = initnewnode();
                    segnode->op = SEG_LABEL;
                    segnode->result.type = STRING;
                    strcpy(segnode->result.str_id,".space   200");
                    armlink_insert(newnode,segnode);
                ...
                case ARRAY_DEF:
                    ...
                    if(rn0 >= 0)
                    {
                        if(check_imme(cur_stk_offset) == 0)
                        {
                            addnode = create_addnode(rn0,REG,R13,IMME,cur_stk_offset,NUL,0);
                            armlink_insert(newnode,addnode);
                        }
                        else
                        {
                            ...
                            ldrnode->result.value = R_res;
                            ldrnode->oper1.type = ILIMME;
                            ldrnode->oper1.value = cur_stk_offset;
                            armlink_insert(newnode,ldrnode);

                            addnode = create_addnode(rn0,REG,R13,REG,R_res,NUL,0);
                            armlink_insert(newnode,addnode);
                        }
                    ...
                    else if(rn0 == -1)
                    {
                        ...
                        if(check_imme(cur_stk_offset) == 0)
                        {
                           movnode = create_movnode(R_res,IMME,cur_stk_offset);
                           armlink_insert(newnode,movnode);
                        }
                        else
                        {
                        ...
                        addnode = create_addnode(R_res,REG,R_res,REG,R13,NUL,0);
                        armlink_insert(newnode,addnode);
                        ...
                        else if (p->opn1.kind == ID)
                        {
                            if (p->opn2.kind == LITERAL)
                            {
                                ...
                                if (rn1 >= 0)
                                {
                                    ...
                                    init_strnode(newnode,R_op2,rn0,rn1,regindex);
                            ...
                            else if (p->opn2.kind == ID)
                            {
                                ...
                                if (rn2 >= 0)
                                {
                                    ...
                                    if (rn1 >= 0)
                                    {
                                        ...
                                        init_strnode(newnode,rn2,rn0,rn1,regindex);
                                        newnode->oper3.type = LSL;
                                        newnode->oper3.value = 2;
                                    }
                                    else if (rn1 == -1)
                            ...
                            else if (p->opn2.kind == ID)
                            {
                                ...
                                if (rn2 >= 0)
                                {
                                    ...
                                    if (rn1 >= 0)
                                    {
                                        ...
                                        init_strnode(newnode,rn2,R_res,rn1,regindex);
                                        newnode->oper3.type = LSL;
                                        newnode->oper3.value = 2;
                                    }
                                    else if (rn1 == -1)
                                ...
                                else if (rn2 == -2)
                                {
                                    ...
                                    else if(rn1 == -2)
                                    {
                                        ...
                                        if (R_op1 != -1)
                                        {
                                            ...
                                            ldrnode = create_ldrnode(R_op1, p->opn1.id, 0, 0);
                                            armlink_insert(newnode, ldrnode);
                                            ldrnode = create_ldrnode(R_op1, 0, R_op1, 0);
                                            armlink_insert(newnode, ldrnode);
                                        ...
                                        else
                                        {
                                            ...
                                            ldrnode = create_ldrnode(reg[0], p->opn1.id, 0, 0);
                                            armlink_insert(newnode, ldrnode);
                                            ldrnode = create_ldrnode(reg[0], 0, reg[0], 0);
                                            armlink_insert(newnode, ldrnode);
                ...
                case ARRAY_EXP:
                    ...
                    if (rn0 >= 0)
                    {
                        ...
                        if (rn1 >= 0) //局部数组，首址在寄存器中
                        {
                            ...
                            else if (p->opn2.kind == ID)
                            {
                                ...
                                if (rn2 >= 0)
                                {
                                    ...
                                    init_ldrnode(newnode,rn0,NULL,rn1,rn2,regindex);
                                    newnode->oper3.type = LSL;
                                    newnode->oper3.value = 2;
                                }
                                else if (rn2 == -1)
                        ...
                        else if (rn1 == -1) //局部数组，首址在内存中
                        {
                            ...
                            ldrnode = create_ldrnode(R_op1,NULL,R13,vartbl->table[vartable_index].index);
                            armlink_insert(newnode,ldrnode);
                            // if(check_imme(vartbl->table[vartable_index].index) == 0)
                            // {
                            //     movnode = create_movnode(R_op1,IMME,vartbl->table[vartable_index].index);
                            //     armlink_insert(newnode,movnode);
                            // }
                            // else
                            // {
                            ...
                            //     ldrnode->result.value = R_op1,
                            //     ldrnode->oper1.type = ILIMME;
                            //     ldrnode->oper1.value = vartbl->table[vartable_index].index;
                            //     armlink_insert(newnode,ldrnode);
                            // }
                            ...
                            else if (p->opn2.kind == ID)
                            {
                                ...
                                if (rn2 >= 0)
                                {
                                    ...
                                    init_ldrnode(newnode,rn0,NULL,R_op1,rn2,regindex);
                                    newnode->oper3.type = LSL;
                                    newnode->oper3.value = 2;
                                }
                                else if (rn2 == -1)
                        ...
                        if(rn1 >= 0)                //局部数组，首址在寄存器中
                        {
                            ...
                            else if (p->opn2.kind == ID)
                            {
                                ...
                                if (rn2 >= 0)
                                {
                                    ...
                                    init_ldrnode(newnode,R_res,NULL,rn1,rn2,regindex);
                                    newnode->oper3.type = LSL;
                                    newnode->oper3.value = 2;
                                }
                                else if (rn2 == -1)
                        ...
                        else if (rn1 == -1) //局部数组，首址在内存中
                        {
                            ...
                            else if (p->opn2.kind == ID)
                            {
                                ...
                                if (rn2 >= 0)
                                {
                                    ...
                                    init_ldrnode(newnode,R_res,NULL,R_op1,rn2,regindex);
                                    newnode->oper3.type = LSL;
                                    newnode->oper3.value = 2;
                                }
                                else if (rn2 == -1)
    ...
    segnode->op = SEG_LABEL;
    segnode->result.type = STRING;
    strcpy(segnode->result.str_id,".data");
    q->next = segnode;
    segnode->pre = q;
    q = segnode;
...
/**
 * @brief Create a addnode object,op3移位用
 * 
 * @param R_res 
 * @param type_op1 
 * @param op1 
...
armcode * create_addnode(int R_res,optype type_op1,int op1,int type_op2,int op2,optype type_op3,int op3)
{
    ...
    anode->oper3.type = type_op3;
    anode->oper3.value = op3;

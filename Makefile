...
all: calc_c.tab.c lex.yy.c ast.c
	gcc -o calc.exe $(CFLAGS) ast.c block.c calc_c.tab.c lex.yy.c semantic_analysis.c Common/list.c Common/hash_set.c Common/hash.c table.c main.c Tac.c \
							  ...
							  toARM/translate.c toARM/print.c toARM/vartableopt.c SomeInterface.c
